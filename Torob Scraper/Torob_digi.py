...
base_name_place3 = "/html/body/div/div/div/div[3]/div/div[2]/div/div[2]/div[2]/div/div[2]/div[2]/div[1]/div/div[%d]/div[1]/div/div/a"
base_name_place4 = "/html/body/div/div/div/div[3]/div/div[2]/div/div[2]/div[2]/div/div[2]/div[2]/div[1]/div[2]/div/div[%d]/div[1]/div/div/a"
...
base_price_place3 = "/html/body/div/div/div/div[3]/div/div[2]/div/div[2]/div[2]/div/div[2]/div[2]/div[1]/div/div[%d]/div[3]/a[1]"
base_price_place4 = "/html/body/div/div/div/div[3]/div/div[2]/div/div[2]/div[2]/div/div[2]/div[2]/div[1]/div[2]/div/div[%d]/div[3]/a[1]"
click_place = "/html/body/div/div/div/div/div/div[2]/div/div/div[2]/div[2]/div/div/div[1]/a/div/h2"
item_list = pd.read_excel("digi_list.xlsx")
    ...
    try:
        for i in range(4):
            try:
                ...
                scrap_url_name = base_name_place3 % (i + 1)
                scrap_url_price = base_price_place3 % (i + 1)
                price = driver.find_element(By.XPATH, scrap_url_price).text
                if (price[:7] == "ناموجود"):
                    break
                price = price.replace("٫", "")
    ...
    try:
        for i in range(200):
            try:
                ...
                scrap_url_name = base_name_place4 % (i + 5)
                scrap_url_price = base_price_place4 % (i + 5)
                price = driver.find_element(By.XPATH, scrap_url_price).text
                if (price[:7] == "ناموجود"):
                    break
                price = price.replace("٫", "")
...
def search(search_url, phone, a, aa):
    ...
    try:
        if aa == 1:
            ...
            try:
                driver.find_element(By.XPATH, "/html/body/div/div/div/div/div/div[2]/div/div/div[2]/div[3]/div/div/div[1]/a/div/h2").click()
            except:
                try:
                    driver.find_element(By.XPATH, "/html/body/div/div/div/div/div/div[2]/div/div/div[2]/div[2]/div/div/div[1]/a/div/h2").click()
                except:
                    pass
    except:
        pass    
    ...
    try:
        driver.find_element(By.XPATH, "/html/body/div/div/div/div[2]/div/div[2]/div/div[2]/div[2]/div/div[2]/div[1]/div[2]/div").click()
    except:
        try:
            driver.find_element(By.XPATH, "/html/body/div/div/div/div[2]/div/div[2]/div/div[2]/div[2]/div/div[2]/div[1]/div[2]/div").click()
        except:
            try:
                driver.find_element(By.XPATH, "/html/body/div/div/div/div[3]/div/div[2]/div/div[2]/div[2]/div/div[2]/div[1]/div[2]/div").click()
            except:
                pass
